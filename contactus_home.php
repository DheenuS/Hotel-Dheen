...
if (!empty($gmail) && !empty($msg) && !is_numeric($gmail)) {
    ...
    echo "<script type='text/javascript'>alert('Thank you...we will reach you soon'); setTimeout(function(){ window.location.href = 'home.php' }, 1000);</script>";/* use single quotes */
}
?>
    ...
    <nav class=" px-[60px] flex items-center justify-between sticky top-0 shadow-xl bg-gray-100 py-[20px] z-40">
        ...
        <div class="container flex justify-end">
            <div class="flex items-center space-x-8 font-normal">
                ...
                <a href="home.php" class="text-black hover:underline underline-offset-8 font-semibold">< Back</a>
            </div>
        </div>
    </nav>
    <!-- Contact Us -->
